...
void VTInputBox::Init(LPDIRECT3DDEVICE9 _dev) {
	...
	this->m_Placeholder = new VTText(this->m_X + (TextWidth / 2) + this->m_Height / 2.5, this->m_Y + (this->m_Height / 3.f), TextWidth, this->m_Height, this->m_Height / 2.3, this->m_FontFamily.c_str(), *this->m_PlaceholderText, false, PlaceholderColor);
	this->m_Placeholder->Init(_dev);

	this->m_Text = new VTText(this->m_X + (TextWidth / 2) + this->m_Height / 2.5, this->m_Y + (this->m_Height / 3.f), TextWidth, this->m_Height, this->m_Height / 2.3, this->m_FontFamily.c_str(), "", false, this->m_TextColor);
